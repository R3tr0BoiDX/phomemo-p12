...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Set Font size. Use [WIDTH - MARGIN] value as default.",
    )
    parser.add_argument(
        "--width",
        type=int,
        default=96,
        help="The number of dots in the hardware tape width direction. default=96",
    )
    parser.add_argument(
        "--margin",
        type=int,
        default=8,
        help="Set width of unprintable region. default=8",
    )
    parser.add_argument(
        "--offset", type=int, default=0, help="Set rendering position offset"
    )
...
def main():
    ...
    y_offset = calc_y_offset(cr, args.text)
